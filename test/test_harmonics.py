...
def test_harmonics():
    ...
    distribution_file = filepath.joinpath(
    ...
    PLM, dPLM = gravtk.associated_legendre(
        LMAX, np.cos(theta), method='mohlenkamp'
    )
    # convert to spherical harmonics
    test_Ylms = gravtk.gen_stokes(
        input_distribution.data,
        input_distribution.lon,
        input_distribution.lat,
        UNITS=1,
        LMAX=LMAX,
        PLM=PLM,
        LOVE=LOVE,
    ...
    test_distribution = gravtk.harmonic_summation(
        smooth_Ylms.clm,
        smooth_Ylms.slm,
        input_distribution.lon,
        input_distribution.lat,
    ...
    test_transform = gravtk.harmonic_transform(
        transform_Ylms.clm,
        transform_Ylms.slm,
        input_distribution.lon,
        input_distribution.lat,
    ...
    test_combine = gravtk.stokes_summation(
        test_Ylms.clm,
        test_Ylms.slm,
        input_distribution.lon,
        input_distribution.lat,
